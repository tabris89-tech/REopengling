...
class TestProject:
    ...
    def test_from_result(self):
        from opengling.core.project import Project
        from opengling.core.models import ProcessingResult, ProcessingConfig, TranscriptSegment, EditDecision, EditType
...
class TestProjectVersioning:
    ...
    def test_version_in_saved_file(self, temp_dir):
        from opengling.core.project import Project, PROJECT_VERSION
        import json
